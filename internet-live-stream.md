...
If you wish to investigate typical browser plugins and their content, I strongly recommend starting your research with BlueMaxima's Flashpoint[^4]. It's currently one of the most comprehensive preservation initiatives for web games, preserving content created for over 30 different browser plugin platforms.
...
Artists created numerous web artworks using Flash and Shockwave as platforms. For instance, Austrian artist LIA crafted RE-MOVE[^6], German artist Esther Hunziker developed UN_FOCUS[^7] using Flash, and American artist Nathaniel Stern incorporated interactive segments made with Flash along with Quicktime video clips for the Hektor website[^8].
...
In May of this year, "Input" published an article titled "Sotheby’s Warhol NFT is Basically a Forgery," quoting criticisms from the Warhol Data Recovery Project participant, Professor Golan Levin of Carnegie Mellon University, highlighting that Sotheby’s auctioned "second-generation near-copies." The auctioned version enlarged the original image from 320x200 pixels to 6000x4500 pixels inaccurately, making it more of an exhibition copy.
...
In 1995, a group of artists created the KUNSTRADIO ON LINE website[^15] to archive broadcasts from the Austrian national radio ORF's cultural channel Oesterreich 1’s radio art program KUNSTRADIO. Real Audio format and RTSP protocol were used to transmit the audio programs on this site.

American artist Caroling Geary released numerous works created using QuickTime VR on her website[^16]. Many QuickTime VR panoramic works created using similar technology were collected and showcased by the panoramic image website World Wide Panorama.

## 3D Graphics on the Web: VRML and X3D

The practice of transmitting 3D content on the internet emerged in the '90s. The first widely used 3D content standard online was VRML (Virtual Reality Modeling Language). Its origins trace back to Dave Raggett, an early participant in the W3C, who published a paper titled "Platform Independent Virtual Reality"[^18] in 1994, referring to VRML as "VR markup language." By the time VRML was standardized in 1995, it was renamed "Virtual Reality Modeling Language."

VRML was quite comprehensive, supporting 3D models, scenes, animations, and hyperlinks for transitioning between different scenes. It facilitated user interaction within the scenes and was widely used in the '90s for building various 3D social network platforms like Cybertown and SAPARi. In 2001, the Web3D Consortium[^19], responsible for maintaining the VRML standard, introduced a new XML-based format called X3D. Even today, the X3D standard is under development and maintenance, similar to SVG (Scalable Vector Graphics) used for 2D graphics in web standards.
...
In the late '90s and early 2000s, VRML found its place in the new media art scene. The European Media Art Festivals (EMAF) in 1999 showcased a series of VRML-based works under the VRML-ART topic[^20].
